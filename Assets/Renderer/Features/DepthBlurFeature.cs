...
public class DepthBlurFeature : ScriptableRendererFeature
{
    ...
    [Header("Bokeh Blur")]
    public RenderPassEvent bokehEvent = RenderPassEvent.BeforeRenderingPostProcessing;
    [Header("Bilateral Blur")]
    public RenderPassEvent bilateralEvent = RenderPassEvent.AfterRenderingPostProcessing;
    ...
    public override void Create()
    {
        ...
        bokehBlurPass.renderPassEvent = bokehEvent;
        bilateralBlurPass = new BilateralBlurPass();
        bilateralBlurPass.renderPassEvent = bilateralEvent;
    }
