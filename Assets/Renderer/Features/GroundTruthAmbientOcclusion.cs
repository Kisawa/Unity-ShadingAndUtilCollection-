...
public class GroundTruthAmbientOcclusion : ScriptableRendererFeature
{
    ...
    [Header("Use _CustomDepthNormalTexture")]
    ...
    class GTAORenderPass : ScriptableRenderPass
    {
        ...
        static string _VIEW_ORIGIN = "_VIEW_ORIGIN";
        static string _VIEW_AO = "_VIEW_AO";
        ...
        public GTAORenderPass(GTAOSetting setting)
        {
            ...
            if (shader == null)
            {
                Debug.LogError("GTAO Render Pass: shader not found.");
                return;
            }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            if (mat == null)
            {
                Debug.LogError("GTAO Renderer Pass: material not created.");
                return;
            }
            ...
            {
                case ViewType.Origin:
                    mat.EnableKeyword(_VIEW_ORIGIN);
                    mat.DisableKeyword(_VIEW_AO);
                    break;
                case ViewType.AO:
                    mat.DisableKeyword(_VIEW_ORIGIN);
                    mat.EnableKeyword(_VIEW_AO);
                    break;
                default:
                    mat.DisableKeyword(_VIEW_ORIGIN);
                    mat.DisableKeyword(_VIEW_AO);
    ...
    public override void Create()
    {
        ...
        name = "Ground Truth Ambient Occlusion";
    }
