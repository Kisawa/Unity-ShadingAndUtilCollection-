...
public class SunShaftFeature : ScriptableRendererFeature
{
    ...
    static int _BlueNoise = Shader.PropertyToID("_BlueNoise");
    ...
    {
#if UNITY_EDITOR
        blueNoise = UnityEditor.AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.unity.render-pipelines.universal/Textures/BlueNoise16/L/LDR_LLL1_0.png");
#endif
    }
    ...
    class SunShaftPass : ScriptableRenderPass, IPass
    {
        ...
        public SunShaftPass(SunShaftFeature feature)
        {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, new ProfilingSampler("Sun Shaft")))
            {
                ...
                mat.SetTexture(_BlueNoise, feature.blueNoise);
    ...
    {
        name = "Sun Shaft";
        sunShaftPass = new SunShaftPass(this);
    ...
    {
        public ClampedFloatParameter Resolution = new ClampedFloatParameter(1, 0, 1);
